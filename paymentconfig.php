...
define('PAYPAL_RETURN_URL','https://cgi.luddy.indiana.edu/~rheeh/Ridea/paymentsuccess.php');
define('PAYPAL_CANCEL_URL','https://cgi.luddy.indiana.edu/~rheeh/Ridea/paymentcancel.php');
define('PAYPAL_NOTIFY_URL','https://cgi.luddy.indiana.edu/~rheeh/Ridea/ipn.php');
