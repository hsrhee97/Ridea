...
if(strcmp($res, "VERIFIED") == 0 || strcasecmp($res, "VERIFIED") == 0){
    ...
    $prevPayment = $db->query("SELECT PaymentID FROM PAYMENT WHERE txn_id= '".$txn_id."'");
    if($prevPayment->num_rows > 0){
        exit();
    }else{
        //Insert transaction data into the database
        $insert = $db->query("INSERT INTO PAYMENT(SurveyID,txn_id,payment_gross,currency_code,payment_status) VALUES('".$SurveyID."','".$txn_id."','".$payment_gross."','".$currency_code."','".$payment_status."')");
    }
}